...
<body background="https://psv4.userapi.com/c235031/u152819152/docs/d43/541a00f6f0b2/Dizayn_bez_nazvania.png?extra=4OByX4xdUt6sRT7ces2O0RvF5cYeUv15S72PeutG-R0uKAl6f1GFfg4xTCZ85wm7FaTCtWX7s4a91i9cfQolCNE9bz3p3RT3Lqp9j8-h_aS-6Gpn4SgLN2dr97rCDEgh31x5ZOiXrHXr59MmEaDgGQA">
<h1 class="hh1">Заказчики</h1>
<div style="margin: 0px 0px 0px 60px;">
    <form method="post" action="/postCustomer" >
        <label  for="surname" class="mt-5 mb-2" >Surname</label>
        <input  name="surname" type="text" id="surname" style="width:249px;"/>
        </br>
        <label for="name" class="mb-2">Name</label>
        <input  name="name" type="text" id="name" style="width:249px;"/>
        </br>
        <label for="phone" class="mb-2">Phone</label>
        <input  name="phone" type="text" id="phone" style="width:249px;"/>
        </br>
        <label for="email" class="mb-2">Email</label>
        <input  name="email" type="text" id="email" style="width:249px;"/>
        </br>
        <label for="car" class="mb-2">Car</label>
        <input  name="car" type="text" id="car" style="width:249px;"/>
        </br>
        <label for="registration_number" class="mb-2">Registration Number</label>
        <input  name="registration_number" type="text" id="registration_number"/>
        </br></br>
...
<div class="container" >
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h2 class="mt-3">Таблица заказчиков</h2>
        </div>
