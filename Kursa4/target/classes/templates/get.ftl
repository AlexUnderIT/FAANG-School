...
<body background="https://psv4.userapi.com/c237231/u152819152/docs/d4/b5de1294cb6d/main.jpg?extra=YQRDfWWsWpsGvxOkqJdB1_5Oe86-hfEtZj6NwrzMMonO2pDZixsqvfClN_Ux7_1ATJAaesYEt1A27-j9cy77_RolCD8oYaKu5kkuElklo8ev6DFZodvl7zkncOGXrZMSztukPPMqbkWbOhgU1HlDSaFr">
...
<section id="headerwrap_2" class="d-flex">
    <div class="container">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h2>Get-запросы и Post-запросы</h2>
            </div>
            <a class="hh2" href="showCategory">Show Categories</a> </br>
            <a class="hh2" href="showBooking">Show Booking</a> </br>
            <a class="hh2" href="showCustomer">Show Customer</a> </br>
        </div>
    </div>
</section>
<footer>
